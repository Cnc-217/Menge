...
/*!
 *	@file		GoalSelectorMatrix.h
 *	@brief		GoalSelectorMatrix. 
 */

#ifndef __GOAL_SELECTOR_MATRIX_H__
#define __GOAL_SELECTOR_MATRIX_H__
...
namespace Menge {
	...
	namespace BFSM {
		...
		public:
			 ...
			 */
			virtual const char * name() const { return "Matrix"; }
