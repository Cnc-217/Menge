...
#ifndef __GOAL_SELECTOR_NEARAGENT_H__
#define __GOAL_SELECTOR_NEARAGENT_H__
...
namespace Menge {
	...
	namespace BFSM {
		 ...
		 *	@brief		
		 */
		class MENGE_API NearAgentGoalSelector : public SetGoalSelector {
		public:
		 ...
		 */
		class MENGE_API NearAgentGoalSelectorFactory : public SetGoalSelectorFactory {
		public:
			 ...
			 */
			virtual const char * name() const { return "near_agent"; }
		...
		protected:
			 ...
			 */
			GoalSelector * instance() const { return new NearAgentGoalSelector(); }
...
#endif // __GOAL_SELECTOR_NEARAGENT_H__
