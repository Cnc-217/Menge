...
#ifndef __GOAL_SELECTOR_EVACUATION_H__
#define __GOAL_SELECTOR_EVACUATION_H__
...
namespace Menge {
	...
	namespace BFSM {
		 ...
		 *	@brief		
		 */
		class MENGE_API EvacuationGoalSelector : public GoalSelector {
		 ...
		 */
		class MENGE_API EvacuationGoalSelectorFactory : public GoalSelectorFactory {
		public:
			EvacuationGoalSelectorFactory();
			/*!
		...
		protected:
			...
			GoalSelector * instance() const {
				return new EvacuationGoalSelector();
			}
		};
	}	// namespace BFSM
}	// namespace Menge
