...
/*!
 *	@file		GoalSelectorEnd.h
 *	@brief		The definition of the "End" goal selector. 
 */

#ifndef __GOAL_SELECTOR_END_H__
#define __GOAL_SELECTOR_END_H__
...
namespace Menge {
	...
	namespace BFSM {
		 ...
		 */
		class MENGE_API EndGoalSelector : public GoalSelector {
		public:
			/*!
		 ...
		 */
		class MENGE_API EndGoalSelectorFactory : public GoalSelectorFactory { 
		public:
			/*!
		...
		protected:
			 ...
			 */
			GoalSelector * instance() const { return new EndGoalSelector(); }	
		};
