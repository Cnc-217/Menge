...
namespace StressGAS {
	 ...
	 */
	class DistanceStressAction : public BaseStressAction {
	public:
		/** Default constructor */
	 ...
	 */
	class DistanceStressActionFactory : public BaseStressActionFactory {
	public:
		 ...
		 */
		virtual const char * name() const { return "stress"; }
