...
/*!
 *	@file		CondLeaderGoal.h
 *	@brief		The definition of the leader goal reached condition.
 */

#ifndef __COND_LEADER_GOAL_H__
#define __COND_LEADER_GOAL_H__
...
namespace Menge {
	...
	namespace BFSM {
		...
		/*!
		 *	@brief		A spatial transition based on leader goal positions.
		 */
		class MENGE_API LeaderGoalCondition : public Condition {
		public:
			/*! 
			 *	@brief		Constructor.
			 */
			 ...
			 */
			LeaderGoalCondition( const LeaderGoalCondition& cond );
		 ...
		 */
		class MENGE_API LeaderGoalCondFactory : public ConditionFactory {
		public:
			/*!
			 *	@brief		Constructor.
			 */
			LeaderGoalCondFactory();
			 ...
			 */
			virtual const char * name() const { return "leadergoal_reached"; }
		...
		protected:
			 ...
			 */
			virtual Condition * instance() const { return new LeaderGoalCondition(); }
